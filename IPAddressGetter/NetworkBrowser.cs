...
namespace Network.Computer.Enumerate
{
    ...
    /// This collection of PC names is used in the <see cref="ListNetworkComputers">
    /// form </see>
    /// <br></br>
    ...
    public class NetworkBrowser
    {
        ...
        private MacAddressFromIpAddressOrName _macAddressGetter;
        ...
        {
            _macAddressGetter = new MacAddressFromIpAddressOrName();
        }
        #endregion
        ...
        public List<string> getNetworkComputers()
        {
            ...
            {
                Trace.WriteLine(string.Format("Problem with acessing network computers in NetworkBrowser {0}" , ex.Message));
                return null;
            }
            finally
            {
